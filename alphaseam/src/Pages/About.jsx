    ...
    <div className="about-page">
      <section className="hero" data-aos="fade-right">
        <div className="text">
          ...
          <p>We are dedicated to streamlining and improving the industry here at GTAsteriX</p>
      ...
      {/* <section className="overview" style={{ backgroundImage: `url(${bgImg})` }}>
        <div className="overlay" data-aos="zoom-in">
          ...
          <p>
            At GTAsterix Pvt Ltd, we fuse innovation and execution to create custom technological
            ...
            solutions. With a proven track record in comprehensive product lifecycle management, we excel in
            transforming challenges into opportunities, ensuring unparalleled efficiency and agility for our clients.
          </p>
